...
function Order() {
  ...
  const handleFilter = () => {
    if (period === "thisWeek") {
      const tempOrder = orders.filter(order => {
        ...
        const orderDate = new Date(`${order.orderDate.substring(0, order.orderDate.indexOf("T"))}`)
      ...
      const tempOrder = orders.filter(order => {
        ...
        const orderMonth = new Date(`${order.orderDate.substring(0, order.orderDate.indexOf("T"))}`) //getting the date from the order.js//
  ...
  return (
    <section>
      ...
      <Month handleChange={handleChange} handleFilter={handleFilter} period={period} />
